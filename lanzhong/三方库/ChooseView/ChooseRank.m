...
-(void)rankView{
    ...
    UILabel *titleLB = [[UILabel alloc] initWithFrame:CGRectMake(20, 5, kSCREEN_WIDTH, 25)];
    titleLB.text = self.title;
    titleLB.font = FONT(15);
    [self.packView addSubview:titleLB];
    
    self.btnView = [[UIView alloc] initWithFrame:CGRectMake(0,CGRectGetMaxY(titleLB.frame), kSCREEN_WIDTH, 40)];
    ...
    for (int i = 0; i < self.rankArray.count; i++) {
        ...
        [btn setBackgroundColor:[UIColor colorWithRed:240/255.0f green:240/255.0f blue:244/255.0f alpha:1]];
...
-(void)btnClick:(UIButton *)btn{
    ...
    if (![self.selectBtn isEqual:btn]) {
        ...
        self.selectBtn.backgroundColor = [UIColor colorWithRed:240/255.0f green:240/255.0f blue:244/255.0f alpha:1];
