...
-(void)creatUI{
    ...
    //半透明视图
    alphaView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, kSCREEN_WIDTH, kSCREEN_HEIGHT)];
    alphaView.backgroundColor = [UIColor blackColor];
    alphaView.alpha = 0.3;
    [self addSubview:alphaView];
    
    //装载商品信息的视图
    whiteView = [[UIView alloc] initWithFrame:CGRectMake(0, 280, kSCREEN_WIDTH, kSCREEN_HEIGHT-280)];
...
//    [whiteView addSubview:LB_line];
    ...
    stockBtn.frame = CGRectMake(0,  whiteView.height-40, kSCREEN_WIDTH, 40);
    ...
    mainscrollview = [[UIScrollView alloc] initWithFrame:CGRectMake(0,0, kSCREEN_WIDTH, whiteView.height+10-60)];
