//
//  GLMine_MyMessage_OtherController.m
//  lanzhong
//
...
#import "GLMine_MyMessage_OtherController.h"
#import "GLMine_MyMessageCell.h"
#import "GLMine_MyMessageModel.h"

@interface GLMine_MyMessage_OtherController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation GLMine_MyMessage_OtherController
...
- (void)postRequest:(BOOL)isRefresh{
    ...
    dic[@"type"] = @"5";//消息分类 1项目捐赠 2项目支持 3兑换 4.充值 5其他
    dic[@"page"] = @(self.page);
