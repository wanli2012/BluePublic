//
//  GLPublish_FundStopController.m
//  lanzhong
//
...
@implementation GLPublish_FundStopController
...
- (void)postRequest:(BOOL)isRefresh{
    ...
    dic[@"state"] = @"4";//项目运行状态 1待审核(审核中) 2审核失败 3审核成功（审核成功认定为筹款中）4筹款停止 5筹款失败 6筹款完成 7项目进行 8项目暂停 9项目失败 10项目完成
    dic[@"page"] = @(self.page);
