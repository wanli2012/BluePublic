//
//  GLMine_Wallet_Exchange_FailedController.m
//  lanzhong
//
...
@interface GLMine_Wallet_Exchange_FailedController ()
...
@implementation GLMine_Wallet_Exchange_FailedController
...
- (void)updateData:(BOOL)status {
    ...
    dict[@"back_status"] = @"0";//兑换状态0审核失败 1审核成功 2未审核
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    GLMine_Wallet_ExchangeModel *model = self.models[indexPath.row];
